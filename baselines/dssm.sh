...
#SBATCH -o /scratch/arjun_dssm.txt
#SBATCH --job-name=dssm_proj
...
papermill  --request-save-on-cell-execute --log-output --log-level INFO --progress-bar DSSM.ipynb /scratch/arjunth2001/DSSM.ipynb