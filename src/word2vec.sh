...
#SBATCH -o /scratch/arjun_w2v.txt
#SBATCH --job-name=w2v
...
papermill  --request-save-on-cell-execute --log-output --log-level INFO --progress-bar word2vec.ipynb /scratch/arjunth2001/word2vec.ipynb